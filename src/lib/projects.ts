...
export const projects: Project[] = [
  {
    ...
    problemSolved:
      "Bridging the gap between property owners and travelers by providing a reliable and intuitive platform for Discovering and listing accommodations with secure authentication and integrated maps.",
    impact:
      "Created a highly functional clone that demonstrates a deep understanding of the MERN stack architecture, handling over 20+ property listings with dynamic map integration and secure user reviews.",
    difficulty:
      "Implementing complex server-side validation using Joi and managing complex state across the frontend while integrating third-party APIs like Mapbox for location services.",
  },
  {
    id: "ideaflow",
    title: "IdeaFlow",
    ...
    problemSolved:
      'Overcoming the "blank page" problem for new startup founders by automating the initial research and documentation phase using Generative AI.',
    impact:
      "Reduces the time taken to create a professional product brief from days to seconds, allowing founders to validate and iterate on their ideas much faster.",
    difficulty:
      "Designing a dynamic Generative UI that updates in real-time as the AI processes the input, and ensuring the AI provides structured, actionable blueprints across different industries.",
  },
  {
    id: "investease",
    title: "InvestEase",
    ...
    problemSolved:
      "Modern investor services are often fragmented across multiple systems for portfolio management, KYC verification, nominee updates, account statements, and customer support, leading to inefficient workflows and inconsistent user experiences.",
    impact:
    ...
    difficulty:
      "Designed a modular three-tier MERN architecture with reusable service layers, dynamic portfolio calculations, and secure JWT role-based authorization.",
  },
];
