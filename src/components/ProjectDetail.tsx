...
const caseStudyData: Record<string, CaseStudy> = {
  ideaflow: {
    ...
    snapshot: {
      ...
      impact:
        "Reduced early-stage planning and documentation cycles from days to 10 seconds of processing time.",
      stack:
        "Next.js + TypeScript + OpenAI API + Tambo AI + Tailwind CSS + Framer Motion",
    },
    before: [
    ...
    timeline: [
      {
        ...
        details:
          "Structured prompt instructions and schemas to ensure deterministic AI outputs.",
      },
      {
        day: "Day 4",
        label: "Frontend & Router Setup",
        details:
          "Assembled responsive Next.js views and routing flows for forms.",
      },
      {
        day: "Day 8",
        label: "API Integrations",
        details:
          "Connected OpenAI and Tambo AI models to serverless function handlers.",
      },
      {
        day: "Day 11",
        label: "Dynamic Generative UI",
        details:
          "Built interactive React cards that render dynamically from parsed AI data.",
      },
      {
        day: "Day 14",
        label: "Optimization & Deployment",
        details:
          "Optimized response times, compiled bundles, and deployed live to Vercel.",
      },
    ],
    logs: [
    ...
    lessons: [
      {
        ...
        desc: "Learned how to structure system prompts to strictly output JSON, preventing parser crashes.",
      },
      {
        title: "Dynamic Component Assemblies",
        desc: "Discovered the power of lazy component rendering based on runtime structured data.",
      },
      {
        title: "Serverless Function Timeouts",
        desc: "Optimized API gateway limits by shifting heavy processing tasks into streams.",
      },
      {
        title: "UX for AI Latency",
        desc: "Designed custom skeletons and simulated log streams to maintain engagement during API loads.",
      },
    ],
    mockScreenshots: [
      {
        ...
        url: "/ideaflow-form",
        visualType: "input",
        imgUrl: "/projects/ideaflow-1.png",
      },
      {
        title: "AI Structuring Engines",
        url: "/ideaflow-processing",
        visualType: "processing",
      },
      {
        title: "Interactive Technical Blueprint",
        url: "/ideaflow-blueprint",
        visualType: "blueprint",
        imgUrl: "/projects/ideaflow-3.png",
      },
      {
        title: "MVP Development Roadmap",
        url: "/ideaflow-roadmap",
        visualType: "roadmap",
        imgUrl: "/projects/ideaflow-4.png",
      },
    ],
  },
  wanderlust: {
    ...
    snapshot: {
      ...
      impact:
        "Created a fully operational platform capable of listing properties, booking dates, and handling geocoding.",
      stack:
        "MongoDB + Express.js + React + Node.js + Passport.js + Mapbox SDK + Render hosting",
    },
    before: [
    ...
    timeline: [
      {
        ...
        details:
          "Designed MongoDB collections with referenced users, properties, and reviews.",
      },
      {
        day: "Day 7",
        label: "Express REST Routing",
        details:
          "Wrote robust Express.js API handlers for secure CRUD actions.",
      },
      {
        day: "Day 15",
        label: "Passport Auth Flow",
        details:
          "Mastered Express cookies, sessions, and strategy authentications.",
      },
      {
        day: "Day 22",
        label: "Mapbox API Geocoding",
        details:
          "Connected client and server layers to Mapbox for location listings.",
      },
      {
        day: "Day 28",
        label: "Deployment on Render",
        details:
          "Wrote environmental configs, verified builds, and deployed platform.",
      },
    ],
    logs: [
    ...
    lessons: [
      {
        title: "NoSQL Schema Modeling",
        desc: "Learned when to embed data vs reference collections to optimize MongoDB read speeds.",
      },
      {
        title: "Middleware Protected Routes",
        desc: "Implemented clean Express middlewares to protect listings editing and posting.",
      },
      {
        title: "Input Schema Validation",
        desc: "Utilized Joi validations to block malformed inputs before database interactions.",
      },
      {
        title: "Third-party API Performance",
        desc: "Optimized map renders by caching geolocated coordinates locally.",
      },
    ],
    mockScreenshots: [
      {
        ...
        url: "/wanderlust-auth",
        visualType: "auth",
        imgUrl: "/projects/wanderlust-auth.png",
      },
      {
        title: "Property Listings Dashboard",
        url: "/wanderlust-listings",
        visualType: "listings",
        imgUrl: "/projects/wanderlust-listings.png",
      },
      {
        title: "Mapbox Location Mapping",
        url: "/wanderlust-map",
        visualType: "map",
        imgUrl: "/projects/wanderlust-map.png",
      },
      {
        title: "Full Listing Overview",
        url: "/wanderlust-overview",
        visualType: "listings",
        imgUrl: "/projects/wanderlust-overview.png",
      },
    ],
  },
  investease: {
    ...
    snapshot: {
      ...
      impact:
        "Delivered a production-inspired MERN platform featuring secure authentication, dynamic portfolio operations, digital KYC workflows, PDF statement generation, and a role-based admin dashboard that streamlines investor and operational workflows.",
      stack:
        "React • Node.js • Express.js • MongoDB Atlas • JWT • Tailwind CSS • PDFKit • Multer • Render • Vercel",
    },
    before: [
    ...
    timeline: [
      {
        ...
        label: "Deployment",
        details:
          "Secure cloud deployment with independent frontend and backend hosting.",
      },
      {
        day: "Security",
        label: "Authentication",
        details: "JWT authentication with role-based authorization.",
      },
      {
        day: "Scalability",
        label: "Architecture",
        details: "Modular MERN architecture supporting future integrations.",
      },
    ],
    logs: [
    ...
    lessons: [
      {
        title: "System Design",
        desc: "Designed a modular three-tier MERN architecture with reusable service layers.",
      },
      {
        title: "Authentication & Security",
        desc: "Implemented JWT authentication, role-based authorization, password hashing, and protected routes.",
      },
      {
        title: "Business Logic",
        desc: "Developed dynamic portfolio calculations, Health Score computation, notification workflows, and event-driven updates.",
      },
      {
        title: "Deployment & DevOps",
        desc: "Configured cloud deployment using Vercel, Render, and MongoDB Atlas while handling production environment variables and deployment workflows.",
      },
    ],
    mockScreenshots: [
      {
        ...
        url: "/landing",
        visualType: "input",
        imgUrl: "/projects/landingpage.png",
      },
      {
        title: "Investor Command Center",
        url: "/dashboard",
        visualType: "processing",
        imgUrl: "/projects/Dashboard-panel.png",
      },
      {
...
const FlowNode = ({
  ...
  const bgColor =
    color === "lime"
      ? "hover:bg-lime-50 dark:hover:bg-lime-900/30"
      : color === "purple"
  ...
  return (
    <div
      className={`relative group ${noZ ? "" : "z-10"} w-full ${width} text-center rounded-xl border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 px-4 py-3 font-bold cursor-pointer transition-all duration-300 shadow-[4px_4px_0px_0px_var(--shadow-color)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none ${bgColor} hover:border-blue-500 dark:hover:border-blue-400`}
      style={{ "--shadow-color": shadowColor } as React.CSSProperties}
    >
      <div className="relative z-10">{title}</div>
      {tooltip && (
        <div
          className={`${tooltipClasses} p-3 bg-slate-900 dark:bg-slate-800 text-white text-xs font-sans rounded-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-[100] shadow-2xl border border-slate-700 leading-relaxed text-left`}
        >
          {tooltip}
...
const WanderlustFlow = () => (
  <div className="flex flex-col items-center w-full max-w-lg mx-auto font-heading">
    <FlowNode
      title="Visitor"
      tooltip="A new user arriving at the landing page."
      color="blue"
    />
    <FlowArrow />
    <FlowNode
      title="Browse Listings"
      tooltip="Exploring available properties globally."
      color="blue"
    />
    <FlowArrow />
    <FlowNode
      title="View Property"
      tooltip="Checking details, images, and reviews."
      color="blue"
    />
    ...
    <div className="w-64 flex justify-between mt-6 gap-4 z-10">
      ...
      <FlowNode
        title="Search & Filter"
        tooltip="Finding specific dates & locations."
        color="lime"
        width="flex-1"
      />
    </div>
    ...
    <div className="mt-8 w-full flex justify-center">
      <FlowNode
        title="Book Stay"
        tooltip="Initiating the booking process."
        color="purple"
      />
    </div>
    <FlowArrow />
    <FlowNode
      ...
      tooltip="Processing via Stripe API."
      color="blue"
    />
    <FlowArrow />
    <FlowNode
      title="Booking Confirmed"
      tooltip="Email notification sent."
      color="lime"
    />
    <FlowArrow />
    <FlowNode
      title="Leave Review"
      tooltip="Post-stay feedback loop."
      color="blue"
    />
  </div>
);
...
const IdeaFlowFlow = () => (
  <div className="flex flex-col items-center w-full max-w-sm mx-auto font-heading">
    <FlowNode
      title="Startup Idea"
      tooltip="The initial seed from the founder."
      color="blue"
    />
    <FlowArrow />
    <FlowNode
      title="Prompt Builder"
      tooltip="Structuring the idea for the LLM."
      color="purple"
    />
    <FlowArrow />
    <FlowNode
      title={<span className="text-xl">Tambo AI</span>}
      tooltip="Core processing engine."
      color="lime"
    />
    <FlowArrow />
    <FlowNode
      title="Idea Analysis"
      tooltip="Evaluating market fit & viability."
      color="blue"
    />
    <FlowArrow />
    ...
    <div className="relative group z-10 w-full max-w-[200px] text-center rounded-xl border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 px-4 py-3 font-bold cursor-pointer transition-all duration-300 shadow-[4px_4px_0px_0px_#f59e0b] hover:translate-x-1 hover:translate-y-1 hover:shadow-none hover:border-amber-500 hover:shadow-[0_0_20px_rgba(245,158,11,0.3)]">
      <div className="text-amber-500 mb-2 uppercase tracking-widest text-xs">
        Generate
      </div>
    ...
    <FlowNode
      ...
      tooltip="User reviews and edits the results."
      color="purple"
    />
    <FlowArrow />
    <FlowNode
      title="Export / Save"
      tooltip="Finalizing the brief to PDF or DB."
      color="blue"
    />
  </div>
);
...
const InvestEaseFlow = () => (
  <div className="flex flex-col items-center w-full max-w-sm mx-auto font-heading">
    <FlowNode
      ...
      tooltip="Role-based JWT access."
      color="blue"
    />
    <FlowArrow />
    <FlowNode
      title={<span className="text-xl">Investor Dashboard</span>}
      tooltip="The central hub for all user operations."
      color="lime"
      width="max-w-[280px]"
    />
      ...
      {[
        {
          ...
          tooltip: "Dynamic value calculation.",
        },
        ...
        <div key={i} className="flex items-center w-full my-2 z-10">
          ...
          <FlowNode
            ...
            color="purple"
            width="w-auto flex-1 text-sm py-2"
          />
        </div>
      ))}
    </div>
    ...
    <FlowNode
      ...
      tooltip="KYC review and support tickets."
      color="rose"
      width="max-w-[280px]"
    />
  </div>
          ...
          <div className="p-6">
            {type === "input" && (
              <div className="space-y-3">
                ...
                <div className="w-full h-10 bg-slate-900 border border-slate-800 rounded-lg p-3 text-xs flex items-center text-slate-500">
                  Enter your startup idea here...
                </div>
                <div className="w-24 h-8 bg-lime-500 rounded-full flex items-center justify-center text-slate-950 font-bold text-xs">
                  Submit Idea
                </div>
              </div>
            )}
              ...
              <div className="space-y-4 flex flex-col items-center justify-center text-center">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-[10px] text-slate-500">
                    Analyzing market size & matching optimal libraries...
                  </div>
                </div>
              </div>
            )}
            ...
            {type === "auth" && (
              <div className="max-w-xs mx-auto space-y-3 w-full border border-slate-800 p-4 rounded-xl bg-slate-900/40">
                <div className="text-center font-heading text-sm text-slate-200">
                  Register Account
                </div>
                <div className="h-8 bg-slate-950 border border-slate-800 rounded-lg p-2 text-[10px] text-slate-650 flex items-center">
                  Username
                </div>
                <div className="h-8 bg-slate-950 border border-slate-800 rounded-lg p-2 text-[10px] text-slate-650 flex items-center">
                  Password
                </div>
                <div className="h-8 bg-lime-50 text-slate-950 rounded-lg font-bold text-[11px] flex items-center justify-center">
                  Sign Up
                </div>
              </div>
            )}
            ...
            {type === "map" && (
              <div className="relative border border-slate-800 bg-slate-900 p-2 rounded-lg h-[150px] overflow-hidden flex items-center justify-center">
                ...
                <div className="z-10 flex flex-col items-center">
                  ...
                  <div className="bg-slate-950 border border-slate-800 px-2 py-1 rounded text-[9px] font-bold text-slate-300 shadow mt-1">
                    Eiffel Tower Listing
                  </div>
                </div>
              </div>
            )}
            ...
            <nav className="relative flex flex-col gap-8 mt-auto mb-auto">
              ...
              {sections.map((section) => (
                <a
                  ...
                  className={`group relative flex items-center gap-4 transition-all z-10 ${
                ...
                >
                  ...
                  <span
                    className={`font-heading text-xs font-bold uppercase tracking-wider transition-opacity ${
                      activeSection === section.id
                        ? "opacity-100"
            ...
            <div className="mx-auto max-w-4xl relative">
              ...
              <section id="overview" className="mb-24 scroll-mt-20">
                <header className="mb-12">
                  <span className="text-sm font-semibold tracking-widest text-[#50e0b3] bg-[#0f172a] px-3 py-1 rounded-full border border-[#50e0b3]/30">
                    CASE STUDY
                  </span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 rounded-3xl border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 p-6 shadow-[8px_8px_0px_0px_#1e293b] dark:shadow-[8px_8px_0px_0px_#f1f5f9]">
                  ...
                  <div className="flex flex-col md:border-r border-slate-200 dark:border-slate-800 pr-2">
                    ...
                    <span className="text-sm font-bold text-slate-800 dark:text-slate-200 font-mono truncate">
                      {study.type}
                    </span>
                  </div>
                  <div className="flex flex-col border-r border-slate-200 dark:border-slate-800 pr-2">
              ...
              <section id="snapshot" className="mb-24 scroll-mt-20">
                <h2 className="font-heading text-4xl mb-8 border-b-[5px] border-lime-400 pb-2 inline-block">
                  Project Snapshot
                </h2>
              ...
              <section id="pitch" className="mb-24 scroll-mt-20">
                <div className="rounded-[40px] border-[3px] border-slate-900 dark:border-slate-100 bg-lime-400 dark:bg-lime-500 dark:text-slate-900 p-8 shadow-[10px_10px_0px_0px_#1e293b] dark:shadow-[10px_10px_0px_0px_#f1f5f9] relative overflow-hidden group">
                  ...
                  <span className="mb-3 inline-block rounded-full bg-white/20 px-4 py-1 text-xs font-bold uppercase tracking-widest">
                    The Pitch
                  </span>
                  <h2 className="font-heading text-3xl md:text-4xl italic z-10 relative">
              ...
              <section id="problem" className="mb-24 scroll-mt-20">
                <h2 className="font-heading text-4xl mb-8 border-b-[5px] border-rose-500 pb-2 inline-block">
                  Problem & Solution
                </h2>
                <div className="flex flex-col gap-8 lg:flex-row lg:items-stretch">
                  <div className="flex-1 flex flex-col justify-center">
                    <h3 className="font-heading text-2xl mb-4 text-slate-900 dark:text-slate-100">
                      Problem Statement
                    </h3>
                  ...
                  <div className="flex-1 rounded-[30px] border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 overflow-hidden shadow-[8px_8px_0px_0px_#1e293b] dark:shadow-[8px_8px_0px_0px_#f1f5f9]">
                    <div className="grid grid-cols-2 border-b-2 border-slate-900 bg-slate-100 dark:bg-slate-800 text-center font-heading py-3 text-sm tracking-wider">
                      <div className="text-rose-600 border-r-2 border-slate-900">
                        BEFORE
                      </div>
                    ...
                    <div className="grid grid-cols-2 divide-x-2 divide-slate-900 text-xs">
                      <div className="p-4 space-y-4">
                        {study.before.map((b, idx) => (
                          <div
                            key={idx}
                            className="flex gap-2 items-start text-slate-600 dark:text-slate-400"
                          >
                            <XCircle
                              size={14}
                      ...
                      <div className="p-4 space-y-4">
                        {study.after.map((a, idx) => (
                          <div
                            key={idx}
                            className="flex gap-2 items-start text-slate-800 dark:text-slate-200"
                          >
                            <CheckCircle2
                              size={14}
              ...
              <section id="architecture" className="mb-24 scroll-mt-20">
                <h2 className="font-heading text-4xl mb-8 border-b-[5px] border-blue-500 pb-2 inline-block">
                        ...
                        <React.Fragment key={i}>
                          <div className="flex-1 flex flex-col items-center gap-4 w-full relative">
                            <div className="relative flex h-28 w-full items-center justify-center rounded-2xl border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 p-6 text-center font-heading text-lg shadow-[6px_6px_0px_0px_#3b82f6] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none dark:text-slate-100">
                              <div className="absolute top-2 left-3 text-xs font-mono font-bold text-blue-500 dark:text-blue-400">
                                0{i + 1}
                              </div>
                          ...
                          {i < project.flowDiagram.length - 1 && (
                            <div className="flex items-center justify-center py-2 lg:py-0">
                              <ArrowRight
                                className="text-blue-500 font-bold rotate-90 lg:rotate-0 animate-pulse"
                                size={24}
                              />
                            </div>
                          )}
                ...
                <div className="rounded-[40px] border-[3px] border-slate-900 dark:border-slate-100 bg-slate-900/90 dark:bg-slate-900/40 backdrop-blur-md p-8 text-white shadow-[12px_12px_0px_0px_#84cc16] relative overflow-hidden transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
                  <div className="absolute top-[-40px] right-[-40px] text-white/5 text-[200px] font-heading">
                    MAP
                  </div>
                  <h3 className="font-heading text-3xl mb-12 relative z-10">
                    Interface Mapping
                  </h3>
                  <div className="flex flex-col gap-6 relative z-10">
                    {project.architecture.map((link, i) => (
                      ...
                      >
                        <div className="flex-1 rounded-xl border border-white/25 bg-white/5 py-4 text-center text-sm lg:text-lg font-medium tracking-wide truncate max-w-[45%]">
                          {link.from}
                        </div>
                        ...
                        <div className="flex-1 rounded-xl border border-lime-400/25 bg-lime-400/5 py-4 text-center text-sm lg:text-lg font-medium text-lime-400 tracking-wide truncate max-w-[45%]">
                          {link.to}
                        </div>
                      </div>
                    ))}
              ...
              <section id="screens" className="mb-24 scroll-mt-20">
                <h2 className="font-heading text-4xl mb-8 border-b-[5px] border-purple-500 pb-2 inline-block">
                  Product Showcase
                </h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-6">
                      ...
                      <div className="p-6 bg-blue-50/50 dark:bg-blue-900/20 rounded-3xl border-2 border-blue-100 dark:border-blue-900/60 italic text-blue-700 dark:text-blue-300 text-sm">
                        "The project successfully proved that complex
                        requirements could be distilled into actionable visual
                        components and flows without overwhelming the end-user."
                      </div>
                    </div>
                    <div className="flex flex-col gap-6">
                      <div className="flex items-center gap-6 rounded-[30px] border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 p-6 shadow-[6px_6px_0px_0px_#84cc16] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
                        ...
                        <div>
                          <p className="font-heading text-xl text-slate-900 dark:text-slate-100">
                            Performance
                          </p>
                          <p className="text-slate-500 dark:text-slate-400 text-xs">
                            Uptime on core processing services.
                          </p>
                          <div className="mt-1.5 flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-semibold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/35 px-2 py-0.5 rounded-md border border-green-200 dark:border-green-900/50">
                              99.9% Uptime
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center gap-6 rounded-[30px] border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 p-6 shadow-[6px_6px_0px_0px_#3b82f6] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
                        ...
                        <div>
                          ...
                          <p className="text-slate-500 dark:text-slate-400 text-xs">
                            Clarifying logic and UI layouts.
                          </p>
                          <div className="mt-1.5 flex items-center">
                            <span className="text-[10px] font-semibold text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/35 px-2 py-0.5 rounded-md border border-rose-200 dark:border-rose-900/50">
                              Excellent Rating
                            </span>
                          </div>
                        </div>
              ...
              <section id="lessons" className="mb-32 scroll-mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {study.lessons.map((l, idx) => (
                    <div
                      key={idx}
                      className="rounded-3xl border-[3px] border-slate-900 dark:border-slate-100 bg-white dark:bg-slate-900 p-6 shadow-[6px_6px_0px_0px_#eab308] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all"
                    >
                      <h3 className="font-heading text-xl text-slate-900 dark:text-slate-100 mb-2">
                        {l.title}
                      </h3>
