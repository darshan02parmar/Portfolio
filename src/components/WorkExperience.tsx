            ...
            >
                ...
                <div id="experience-container" className="mb-6 flex flex-col gap-6">
                    <div data-aos="fade-left">
                        <div className="wrapper flex flex-col gap-4 rounded-[30px] border-[3px] border-slate-900 dark:border-slate-100 p-6 shadow-[4px_4px_0px_0px_#1e293b] dark:shadow-[4px_4px_0px_0px_#f1f5f9] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none bg-white/10 dark:bg-slate-900">
                            ...
                            <ul className="flex flex-col gap-3 text-slate-700 dark:text-slate-300">
                                <li className="flex gap-3 text-lg bg-white/80 dark:bg-slate-900/80 rounded-lg shadow-md px-4 py-2 hover:border-l-4 border-slate-700 dark:border-slate-300 transition-all duration-100">
