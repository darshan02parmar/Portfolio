...
const BlogHome = () => {
  const latestPosts = [
    blogs[0],
    {
      ...
      description:
        "I'm currently documenting my process of building this portfolio and diving deep into React, Node.js, and modern AI tools. Check back shortly for new content!",
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-lime-200 transition-colors duration-300 relative overflow-hidden font-sans">
      ...
      <header className="pt-24 pb-12 px-6 sm:px-8 max-w-6xl mx-auto relative z-10">
        ...
        <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
          Things I’m learning, building, debugging, and figuring out along the
          way.
        </p>
      </header>
      ...
      <footer className="text-center pb-24 px-6 text-slate-500 dark:text-slate-400 text-sm font-medium relative z-10">
        ...
        <a
          href="https://twitter.com/darshanparmar03"
          target="_blank"
          rel="noopener noreferrer"
          className="underline hover:text-slate-900 dark:hover:text-white transition-colors text-slate-700 dark:text-slate-300"
        >
          Twitter
        </a>{" "}
        for updates.
