                ...
                <div className="flex flex-col gap-6">
                    {years.map((year) => (
                        <div data-aos="fade-left" key={year}>
                            <div className="disable-scrollbar flex wrapper rounded-[30px] border-[3px] border-slate-900 p-6 shadow-[4px_4px_0px_0px_#1e293b] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none bg-white">
                                <GitHubCalendar
